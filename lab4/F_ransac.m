...
% Extrahiere homogene Merkmalspunkte
...
i = 1;
% Die Größe des größten gefundenen Consensus Sets
largest_set_size=0;
% Die Sampson-Distanz des größten gefundenen Consensus Sets
...
while i<=s
    ...
    index=randperm(no_points);
    
    %Bestimme F-Matrix aus den zufällig gewählten k Punktpaaren
    F = achtpunktalgorithmus(Korrespondenzen(:,index(1:k)));
    ...
    % Anzahl der Inlier und Wert der Sampson-Distanz für diese Punkte
